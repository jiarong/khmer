...
def best_merge_assemble_sequences(f, assemble_dir, try_k=(35, 50, 70,)):
    ...
    # save in dest_dir
    shutil.copy('%s/%s.sga.%d-contigs.fa' %(assemble_dir, TAG, best_k), dest_dir)
    ...
    for k in try_k[1:]:
        ...
        # save in dest_dir
        shutil.copy('%s/%s.sga.%d-contigs.fa' %(assemble_dir, TAG, k), dest_dir)
